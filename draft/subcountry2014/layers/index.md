...
layout: article
title: "Layers"
excerpt: "OHI layers for Denmark"
share: false
ads: false
...
| value units       | value                                                      |
| value range       | 0.7045918 to 0.7045918                               |
...
| value units       | value                                                      |
| value range       | 0.2461164 to 0.3376822                               |
...
| value range       | 0.434347 to 0.434347                               |
...
| value units       | pressure score                                                      |
| value range       | 0.2803126 to 0.2803126                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.2207032 to 0.2207032                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.8791522 to 0.8791522                               |
| global extraction | raster | equal:  |
...
| value units       | rank                                                      |
| value range       | 747.503 to 17401.96                               |
...
| value units       | km^2                                                      |
| value range       | 4.724307 to 117.0911                               |
...
| value range       | 0.0007767996 to 0.0007767996                               |
...
| value units       | trend score                                                      |
| value range       | 0.002281072 to 0.002281072                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | -4.618709e-05 to -4.618709e-05                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | 0.2182331 to 0.2182331                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value range       | 0.001298684 to 0.3048318                               |
...
| value units       | resilience score                                                      |
| value range       | 0.7825558 to 0.7825558                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.7630648 to 0.7630648                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8106215 to 0.8106215                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.2218675 to 0.2218675                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.2017427 to 0.2017427                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.2179826 to 0.2179826                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | value                                                      |
| value range       | 0.991352 to 0.991352                               |
...
| value units       | trend score                                                      |
| value range       | 0.01949698 to 0.04792672                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.001158853 to 0.04197708                               |
...
| value units       | pressure score                                                      |
| value range       | 0.1763361 to 0.1763361                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value range       | 1411278107 to 1.01233e+11                               |
...
| value units       | count                                                      |
| value range       | 4579603 to 5590478                               |
...
| value range       | 3.320312 to 7.224962                               |
...
| value units       | 2010 USD                                                      |
| value range       | 58413.95 to 238506.4                               |
...
| value units       | jobs                                                      |
| value range       | 22599.84 to 873163.8                               |
...
| value units       | resilience score                                                      |
| value range       | 0.0130472 to 0.0130472                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | people                                                      |
| value range       | 35788.52 to 1481577                               |
...
| value units       | resilience score                                                      |
| value range       | 0.5827675 to 0.5827675                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | score                                                      |
| value range       | 0.0003314654 to 0.9673104                               |
...
| value units       | pressure score                                                      |
| value range       | 0.1870543 to 0.1870543                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.2606346 to 0.2606346                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.0420154 to 0.0420154                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.5119265 to 0.5119265                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | km^2                                                      |
| value range       | 87.25128 to 746.1743                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | km^2                                                      |
| value range       | 113.321 to 2808.64                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | pressure score                                                      |
| value range       | 0.002264101 to 0.002264101                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.6047082 to 0.6047082                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8403359 to 0.8403359                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8654587 to 0.8654587                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | -0.1142866 to -0.1142866                               |
| global extraction | equal: global trends were applied equally to each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.1466237 to 0.1466237                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | jobs                                                      |
| value range       | 598.1473 to 28437.48                               |
...
| value units       | resilience score                                                      |
| value range       | 0.8533763 to 0.8533763                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
